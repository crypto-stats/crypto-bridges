...
import { addLeadingZero, convertDataForGraph, needsLandscape } from '../utils';
...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    const updateMenu = () => setLandscape(needsLandscape());
  ...
  return (
    <Motion key={router.asPath}>
      <menu
        className={isLandscape ? styles.menuLandscape : styles.menuPortrait}
      >
